...
class PredictionModel extends Prediction {
  ...
  factory PredictionModel.fromFirestore(
    ...
    return PredictionModel(
      ...
      nomineeProposalIds: (data['nomineeProposalIds'] as List?)?.map((e) => e as String).toList(),
  ...
  Map<String, dynamic> toFirestore() {
    ...
    if (nomineeProposalIds != null) data['nomineeProposalIds'] = nomineeProposalIds;
    if (savedByProfessorsId != null) data['savedByProfessorsId'] = savedByProfessorsId;
